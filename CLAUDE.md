...
3. 按当前工作主题预读相关 `.planning/threads/*.md`（如做策略相关 → `market-microstructure.md`）
4. **明确告知用户**：上次到哪、本次该做什么、第一条命令是什么
...
1. 跑 `/gsd-extract_learnings`
2. 提 **3-5 个对手测试问题**（实战决策题，不是知识题）
3. 答得上 → 进入下一 phase；答不上 → 就这个问题展开教学
4. 评估完成度，更新 ROADMAP
