...
RECEIPT_COUPLED_BUSINESS_RESEARCH_INDEX_GATE_COMMANDS = {
    "planning": ["make", "planning-status"],
    "unit": [
        "uv", "run", "pytest", "tests/alembic/test_040.py",
        "tests/m1-perception/test_control_plane_postgres.py",
        "-k", "business_structure_page or business_quote_page or atomically_stages_business",
        "-q",
    ],
    "integration": [
        "uv", "run", "pytest", "tests/m1-perception/test_control_plane_api.py",
        "tests/m1-perception/test_transactional_structure_worker.py",
        "tests/m1-perception/test_transactional_quote_worker.py", "-q",
    ],
    "cli": ["make", "dashboard-typecheck"],
    "restart": ["make", "docs-m1-check"],
}
...
DETERMINISTIC_RUNTIME_PRODUCTION_ENABLEMENT_GATE_COMMANDS = {
    ...
    "integration": [
        ...
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_heartbeat_outage_adapter_renews_and_completes_the_same_attempt",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_worker_exit_adapter_reclaims_only_after_expiry_and_fences_old_owner",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_retry_budget_adapter_opens_one_incident_and_releases_one_successful_probe",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_source_receipt_gap_adapter_releases_one_complete_materializer_turn",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_quote_batch_incomplete_adapter_blocks_partial_pointer_then_certifies",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_quote_admission_missing_shard_adapter_restores_exact_input_then_admits",
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_normalization_payload_corrupt_adapter_quarantines_and_preserves_pointer",
        ...
        "tests/m1-perception/test_transactional_runtime_coverage.py::test_stale_quote_pointer_adapter_blocks_business_fact_then_resolves_on_fresh_lineage",
        ...
        "tests/m1-perception/test_transactional_quote_worker.py::test_transactional_worker_terminalizes_missing_clob_leg_without_retrying_batch",
        ...
        "tests/m1-perception/test_control_plane_postgres.py::test_quote_pointer_lineage_rejects_late_older_certifier",
        "tests/m1-perception/test_control_plane_postgres.py::test_structure_shadow_pointer_rejects_stale_expected_predecessor",
        "tests/m1-perception/test_control_plane_postgres.py::test_quarantined_finish_atomically_records_terminal_fact_incident_and_alert",
        "tests/m1-perception/test_transactional_quote_admission.py::test_quote_admitter_missing_v3_shard_records_safe_exact_artifact_identity",
        ...
        "tests/m1-perception/test_production_commissioning_harness.py::test_heartbeat_outage_harness_runs_real_isolated_node_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_worker_exit_harness_runs_real_isolated_node_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_retry_budget_harness_runs_real_isolated_node_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_source_receipt_gap_harness_runs_target_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_quote_batch_incomplete_harness_runs_target_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_quote_admission_missing_shard_harness_runs_target_and_cleans_database_and_roles",
        "tests/m1-perception/test_production_commissioning_harness.py::test_normalization_payload_corrupt_harness_runs_target_and_cleans_database_and_roles",
        ...
        "tests/m1-perception/test_production_commissioning_harness.py::test_clob_missing_leg_harness_terminalizes_without_retry_or_circuit",
        ...
        "tests/m1-perception/test_production_commissioning_harness.py::test_incomplete_attack_is_archived_without_overwrite_before_resume",
        "tests/m1-perception/test_production_commissioning_harness.py::test_nested_commissioning_error_summary_keeps_only_safe_owned_codes",
    ...
    "cli": [
        ...
        "tests/m1-perception/test_makefile_contract.py::test_make_heartbeat_outage_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_worker_exit_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_retry_budget_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_source_receipt_gap_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_quote_batch_incomplete_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_quote_admission_missing_shard_commissioning_executes_exact_harness_command",
        "tests/m1-perception/test_makefile_contract.py::test_make_normalization_payload_corrupt_commissioning_executes_exact_harness_command",
        ...
        "tests/m1-perception/test_makefile_contract.py::test_make_complete_commissioning_declares_control_plane_runtime_identity",
        "-q",
    ],
    "restart": [
        "uv",
...
def gate_commands_for(manifest: Mapping[str, object]) -> Mapping[str, list[str]]:
    ...
    elif manifest.get("paradigm") == "receipt-coupled-business-research-index":
        commands = RECEIPT_COUPLED_BUSINESS_RESEARCH_INDEX_GATE_COMMANDS
