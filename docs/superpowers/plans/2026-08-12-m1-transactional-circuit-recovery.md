...
- [x] **Step 3: Implement revision and fenced transitions**
...
- [x] **Step 1: Write failing worker and snapshot tests**
...
- [x] **Step 3: Implement minimal recovery calls and projection**
...
- [x] **Step 1: Write failing rollout contract**
...
- [x] **Step 3: Implement revision-014 preflight/rollout and learning evidence**
...
- [x] **Step 4: Verify final local gate and commit**
