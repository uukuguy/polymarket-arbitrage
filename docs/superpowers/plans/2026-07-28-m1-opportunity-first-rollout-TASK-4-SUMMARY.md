...
group and event. A versioned canonical baseline digest rejects equal-count row
substitution, while atomic per-group diff evidence binds every action to its
baseline/staging/result revision and makes all five published counters
replayable.
...
Verification: 45 focused tests, proportional regression, and all 2,507
