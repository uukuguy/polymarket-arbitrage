...
> 唯一当前状态入口。最后核验：2026-07-17 18:21 CST。
...
| M1 L2 Fly 服务 | `/health` 503；60 assets 已订阅但 WS/candidate/mirror 分别约 20/40/21 天 stale | 当前不可作为可信实时 orderbook 数据源 |
...
恢复 M1 L2 新鲜度；Phase 05 Plan 06 的 24h soak 在此之前不得启动。
