...
export default async function QuotesPage() {
  ...
  const counts = page?.status === "available" && page.summary && typeof page.summary.state_counts === "object" && page.summary.state_counts !== null ? page.summary.state_counts as Record<string, unknown> : {};
