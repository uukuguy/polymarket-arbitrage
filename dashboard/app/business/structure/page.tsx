...
export default async function StructurePage() {
  ...
  return <BusinessShell overview={overview.data} title="Structure research" subtitle="Current market structures worth researching before price and execution analysis.">
